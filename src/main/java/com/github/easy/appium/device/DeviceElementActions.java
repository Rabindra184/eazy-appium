...
import static com.github.easy.appium.checker.DeviceChecker.checkDeviceElementEnabled;
 ...
 */
public class DeviceElementActions<D extends AppiumDriver, E extends Device<D, T>, T extends TouchAction<T>> {
     ...
     * @since 26-Apr-2017 6:39:03 PM
     */
    public DeviceElementActions (final E device, final String name, final WebElement element, final T touch) {
        this.device = device;
        this.name = name;
     ...
     */
    public void clear () {
        perform ("Clearing", WebElement::clear);
    }
     ...
     */
    public void click () {
        perform ("Clicking on", WebElement::click);
    }
    ...
    public boolean enabled () {
        return getValue ("Checking if element [{}] is enabled...", WebElement::isEnabled);
    }
    ...
    public void nTaps (final int times) {
        perform (format ("Performing [{0}] taps on", times), e -> {
            final Point center = e.getLocation ();
    ...
    public boolean selected () {
        return getValue ("Checking if element [{}] is selected...", WebElement::isSelected);
    }
     ...
     */
    public void submit () {
        perform ("Performing submit", WebElement::submit);
    }
     ...
     * @since 21-Mar-2021
     */
    public void swipe (final WebElement targetElement, final SwipeDirection direction,
     ...
     */
    public String text () {
        return getValue ("Getting text on element [{}]...", WebElement::getText);
    }
    ...
    public boolean visible () {
        return getValue ("Checking if element [{}] is visible...", WebElement::isDisplayed);
    }
    ...
    private <R> R getValue (final String message, final Function<WebElement, R> func) {
    ...
    private void perform (final String action, final Consumer<WebElement> consumer) {
        checkElementEnabled ();
    ...
    private T swipeTo (final WebElement targetElement, final SwipeDirection direction,
